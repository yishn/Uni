...
Flache Morphismen lokal von endlicher Präsentation sind universell offen. Der *étale Situs* eines Schemas `X` ist gegeben durch alle étalen Morphismen `Y\to X` mit surjektiven Familien als Überdeckungen. ~~flach|Schema-Morphismus~~ ~~unverzweigt|Schema-Morphismus~~ ~~étale|Schema-Morphismus~~ ~~étale|Situs (Schema)~~
