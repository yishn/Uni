...
is admissible. Now let $V\subset X$ be an open subscheme. By the approximation theorem, we can choose the $D_i$ and the $D'_j$ so that their support is in $V_0$ and $\sigma (V_0)$ respectively.
