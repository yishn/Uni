...
In this section we shall show that $\sigma: G_K\to G_{K'}$ induces group isomorphisms $\varphi_n: K'^\times/n\to K^\times/n$. Due to Proposition \ref{prop:kummer-theory}, we have isomorphisms:
