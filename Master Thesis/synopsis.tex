...
\item $\operatorname{Spv}^{(2)}(K) = \operatorname{Spv}_\text{d}^{(2)}(K)$
\end{enumerate}
\end{lemma}
...
\item Let $v$ be a valuation of rational rank $2$. Due to Lemma \ref{rank-dimension-inequality}, the dimension inequality is an equality. \qedhere
\end{enumerate}
\end{proof}
