...
for some $d \leq \infty$, where $\Gamma'$ denotes the value group and $k'$ the residue field of the unique prolongation of $w$ to $L$. Note that $(\Gamma':\Gamma)<\infty$ and $\operatorname{rank}(w) = \operatorname{rank}(v)$ in an algebraic field extension ([ZS] Ch. VI, §11, Lemma 1 and 2).
\end{proof}
