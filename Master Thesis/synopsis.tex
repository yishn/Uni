...
\begin{proof}
The compositum $K_{v_1}K_{v_2}$ in a fixed separable closure of $K$ is henselian with respect to both $v_1$ and $v_2$, hence separably closed by Theorem \ref{theorem-fkschmidt}. Therefore:
