...
\end{align*}
for almost all $P\in X_0$. Note that $\varphi_P: k(P')\to k(P)$ is a field isomorphism and that the residue maps $r_{P}: \mathcal{O}_{P} \to k(P)$ are ring homomorphisms. Therefore, $\varphi(x+y) = \varphi(x) + \varphi(y)$.
\end{itemize}
\end{proof}
