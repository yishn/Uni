...
\item Die Garbe $f^\ast\mathcal{E}$ besitzt eine Filtration von lokal freien Garben:
...
\begin{remark}
Chern-Klassen sind eindeutig durch die Eigenschaft (iii) bestimmt.
\end{remark}

\begin{definition}
Für ein Vektorbündel $p:E\to X$ vom Rang $r$ mit Nullschnitt $s:X\to E$ definieren wir den \textit{Gysin-Rückzug} entlang des Nullschnitts als:
