...
\item $X$ heißt \textit{nicht-singulär}\index{Kurve!nicht-singulär}, falls alle lokalen Ringe von $X$ regulär sind.
\end{itemize}
...
\[0\to\operatorname{Hom}_C(\Omega_{C/B},M)\to\operatorname{Hom}_C(\Omega_{C/A},M)\to\operatorname{Hom}_C(\Omega_{B/A}\otimes_B C,M)\dashrightarrow 0  \]
...
\[0\to\operatorname{Der}_B(C,M)\to\operatorname{Der}_A(C,M)\to\operatorname{Der}_A(B,M)\dashrightarrow 0 \]
