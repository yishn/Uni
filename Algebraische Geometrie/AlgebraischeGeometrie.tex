...
Dieser ist endlich nach (i). Also ist $f^{-1}(y)=\operatorname{Spec}(A)$ affin, wobei $A$ ein endlich dimensionierter $\kappa(y)$"~Vektorraum ist. Somit ist $\dim f^{-1}(y)=0$, als topologischer Raum ist $f^{-1}(y)$ also eine endliche Menge an Punkten.
\end{enumerate}
