...
\paragraph{Satz 7.16.}\label{7.16} Sei $\pi:\mathbf{P}(\mathcal{E})\to X$ ein projektives Vektorbündel von $X$ und $g:Y\to X$ ein Morphismus. Dann gibt es genau dann einen Morphismus $f$ mit kommutativen Diagramm
\[\begin{tikzcd}
