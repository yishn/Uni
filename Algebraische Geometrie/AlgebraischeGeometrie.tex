...
\begin{enumerate}[(i)]
\item \textit{(Erste fundamentale exakte Sequenz)}\index{Fundamentale exakte Sequenz} Es gibt eine kurze exakte Sequenz:
\[\begin{tikzcd}
...
\paragraph{Korollar 8.10.}\label{8.10} Ist $B$ eine endlich erzeugte $A$"~Algebra oder Lokalisierung einer endlich erzeugten $A$"~Algebra, so ist auch $\Omega_{B/A}$ endlich erzeugt.
