...
\paragraph{Definition 7.14.}\label{7.14} Sei $X$ ein noethersches Schema und $\mathcal{E}$ eine lokal freie, kohärente Garbe auf $X$. Sei $\mathcal{S}=S(\mathcal{E})$ die symmetrische Algebra von $\mathcal{E}$ und $\mathbf{P}(\mathcal{E})=\operatorname{\mathbf{Proj}}(\mathcal{S})$. Dann ist $\mathcal{S}$ eine Garbe von graduierten $\mathcal{O}_X$"~Algebren, die $(\star)$ erfüllt. $\pi:\mathbf{P}(\mathcal{E})\to X$ heißt \textit{projektives Vektorbündel}\index{Vektorbündel!projektiv} über $X$.
