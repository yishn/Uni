...
\paragraph{Satz 12.1.}\label{12.1} \textit{(Dualität für den projektiven Raum)}\index{Serre-Dualität} Sei $X=\mathbf{P}_k^n$ und $\omega_X=\bigwedge^n\Omega_{X/k}$ die $n$-te äußere Potenz von $\Omega_{X/k}$, die sogenannte \textit{kanonische Garbe}\index{kanonische Garbe} auf $X$. Dann ist $\omega_X$ eine invertierbare Garbe und es gilt:
\begin{enumerate}[(i)]
