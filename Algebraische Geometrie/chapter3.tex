...
Sei nun $n\geq 0$. Dann ist $\mathrm{H}^0(X,\mathcal{O}_X(n))$ ein freier $A$"~Modul mit Basis $\{X_0^{m_0}\cdots X_r^{m_r}\mid m_i\geq 0,\ \sum m_i=n\}$. $\mathrm{H}^r(X,\mathcal{O}_X(-n-r-1))$ ist freier $A$"~Modul mit Basis $\{X_0^{e_0}\cdots X_r^{e_r}\mid e_i<0,\ \sum e_i = -n-r-1\}$. Auf Ebene der Čech-Kohomologie ist die Paarung gegeben durch:
\begin{align*}
...
\begin{align*}
0=\mathrm{H}^{r-2}(X,\mathcal{F}_H)&\longrightarrow\mathrm{H}^{r-1}(X,\mathcal{F}(-1))\stackrel{\cdot X_r}{\longrightarrow}\mathrm{H}^{r-1}(X,\mathcal{F})\\
&\longrightarrow\mathrm{H}^{r-1}(X,\mathcal{F}_H)\stackrel{\delta}{\longrightarrow}\mathrm{H}^r(X,\mathcal{F}(-1))\stackrel{\cdot X_r}{\longrightarrow}\mathrm{H}^r(X,\mathcal{F})\qedhere
\end{align*}
\end{enumerate}
