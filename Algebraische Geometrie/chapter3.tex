...
\end{align*}
In $\mathrm{H}^r(X,\mathcal{O}_X(-r-1))$ gilt $X_0^{m_0+e_0}\cdots X_r^{m_r+e_r}\neq 0$ genau dann, wenn $m_i+e_i = -1$ für alle $i$ gilt. Somit ist durch $\{X_0^{-m_0-1}\cdots X_r^{-m_r-1}\in\mathrm{H}^r(X,\mathcal{O}_X(-n-r-1))\mid m_i\geq 0,\ \sum m_i=n\}$ eine Dualbasis gegeben und die Paarung ist somit perfekt.
